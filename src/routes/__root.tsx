  ...
  return (
    <div className="min-h-screen grid place-items-center p-6">
      <div className="brutal-card p-10 max-w-md text-center bg-banana">
        ...
        <a
          href="/"
          className="inline-block mt-6 px-6 py-3 bg-coral border-4 border-ink rounded-2xl font-black brutal-shadow-sm"
        >
          Back to base
        </a>
      </div>
    ...
    <div className="min-h-screen grid place-items-center p-6">
      <div className="brutal-card p-8 max-w-md text-center bg-peach">
        ...
        <div className="mt-6 flex gap-3 justify-center">
          ...
          <a
            href="/"
            className="px-5 py-2 bg-card border-4 border-ink rounded-2xl font-black brutal-shadow-sm"
          >
            Home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "QuestKid — Gamified Learning for Curious Kids" },
      {
        name: "description",
        content:
          "A bright, playful learning platform where kids unlock courses, earn badges, and climb the leaderboard.",
      },
      { property: "og:title", content: "QuestKid — Gamified Learning" },
      {
        property: "og:description",
        content: "Bright, playful, gamified learning for curious kids.",
      },
